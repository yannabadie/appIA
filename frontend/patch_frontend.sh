...
cd ~/my-double-numerique/frontend

# Mets à jour les modules JS (optionnel mais conseillé)
npm install

# Patch le composant principal App.jsx/tsx :
cat > src/App.jsx << 'EOF'
...
# Installe Tailwind (si ce n’est pas déjà fait)
npm install -D tailwindcss postcss autoprefixer
npx tailwindcss init -p

# (Si tailwind.config.js existe déjà, ne fais rien.)

echo "Patch front appliqué ! Redémarre 'npm run dev' et tu auras le nouveau chat complet."
